...
## Question 2
Create a new DataFrame that includes employees from the "DEPARTMENT OF EDUCATION ADMIN" agency where the columns are "First Name", "Last Name", "Title Description", "Base Salary", and "Total OT Paid". Additionally, include a new column "Total Compensation" which is the sum of "Base Salary" and "Total OT Paid".
...
## Question 5
Sort the dataset by "Fiscal Year" and "Total Other Pay" in descending order, then set "First Name" as the index and use the loc accessor to retrieve the "Total Other Pay" for a specific first name, say "John".
...
## Question 7
Sort the dataset first by "Work Location Borough" alphabetically, and then by "Total Compensation" (sum of "Base Salary" and "Total OT Paid") in descending order within each borough.
