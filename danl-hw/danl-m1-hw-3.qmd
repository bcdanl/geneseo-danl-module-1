...
- Create a new `DataFrame` that includes employees from the "DEPARTMENT OF EDUCATION ADMIN" *agency*, where the variables are "First Name", "Last Name", "Title Description", "Base Salary", and "Total OT Paid". 

- Additionally, include a new variable, "Total Compensation", which is the sum of "Base Salary" and "Total OT Paid".
...
## Question 7
- Calculate the *total* "Regular Gross Paid" for employees whose "Base Salary" is below the median salary of the DataFrame.
  - The total "Regular Gross Paid" refers to the total amount of "Regular Gross Paid" paid to employees.
