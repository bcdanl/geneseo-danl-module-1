...
- Laptop or personal computer
  - Operating System: It is recommended to have **Mac** or **Windows**.
  - Specification: It is recommended to have 2+ core CPU, 4+ GB RAM, and 500+ GB disk storage.
...
:::{}
- [Google Colab](https://colab.research.google.com/){target="_blank"} is analogous to Google Drive, but specifically for writing and executing Python code in your browser.
...
- Ultimately, they are intuitive to use and let you jump right into the code and data analysis without needing to worry about the more cumbersome details needed to run Python notebooks on a personal computer.
